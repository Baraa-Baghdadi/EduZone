...
export class ListComponent {
   ...
   */
    ...
    getAllCertificates(){
      this.service.getMyStudientsCertificatesByInput(this.certificateFilter).subscribe({
    ...
    ngAfterViewInit(): void {
      fromEvent(this.search.nativeElement,'keyup').pipe(
        ...
        switchMap((value:string)=>{
          ...
          return this.service.getMyStudientsCertificatesByInput(this.certificateFilter);
        }),
    ...
    downloadCertificate(id){
      this.service.instructorDownlaodCertificateById(id).subscribe(res => {
