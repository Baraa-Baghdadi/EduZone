...
import { NotificationInstructorService } from '@proxy/notifications';
...
export class NotificationListenerService {
  reciveNewStudentListener = new BehaviorSubject<boolean>(false);
  ...
  constructor(private notificationsService : NotificationInstructorService) { }
  increaseCount(){
  ...
  this.notificationsService.getListOfInstructorNotificationByInput(notificationFilter)
    .subscribe((data:any) => {
